...
export const componentMeta = {
  ...
  'vp-counter': {
    ...
    props: [
      ...
      { name: 'centerValue', type: 'string|number',                 required: false, description: 'Row layout only — single value rendered centered inside the central hex divider.' },
      { name: 'centerLeft',  type: 'string|number',                 required: false, description: 'Row layout only — value rendered left of the centerIcon inside the central hex.' },
      { name: 'centerRight', type: 'string|number',                 required: false, description: 'Row layout only — value rendered right of the centerIcon inside the central hex.' },
      { name: 'centerIcon',  type: 'ReactNode',                     required: false, description: 'Row layout only — pictogram between centerLeft and centerRight (defaults to a dot). Set null to hide.' },
    ],
