...
export const componentMeta = {
  ...
  'tabs': {
    ...
    showcaseRoute: '/tabs',
    props: [
      { name: 'items',       type: 'Array<{value, label, icon?, badge?, disabled?, closable?}>',  required: true,  description: 'Seznam záložek. closable: true zobrazí × pokud je předaný onClose.' },
      ...
      { name: 'size',        type: "'xs'|'sm'|'md'|'lg'",                                         required: false, default: "'md'",        description: 'Velikost záložek.' },
      ...
      { name: 'onClose',     type: '(value: string) => void',                                 required: false, description: 'Callback pro zavření záložky. Aktivuje × ikonu na items s closable: true.' },
    ],
  ...
  'select': {
    ...
    props: [
      ...
      { name: 'size',        type: "'xs'|'sm'|'md'|'lg'",                                      required: false, default: "'md'",      description: 'Výška triggeru.' },
  ...
  'slider': {
    ...
    props: [
      ...
      { name: 'size',        type: "'xs'|'sm'|'md'|'lg'",                                      required: false, default: "'md'",       description: 'Výška traku.' },
      { name: 'variant',     type: "'default'|'success'|'danger'|'warning'|'info'",       required: false, default: "'default'",  description: 'Color variant.' },
  ...
  'tooltip': {
    ...
    props: [
      ...
      { name: 'placement',  type: "'top'|'bottom'|'left'|'right' + '-start'|'-end'",  required: false, default: "'top'",     description: '12 hodnot: 4 strany × 3 zarovnání (default/-start/-end).' },
      ...
      { name: 'autoFlip',   type: 'boolean',                                           required: false, default: 'true',      description: 'Automaticky otoč na opačnou stranu pokud by tooltip přesahoval viewport.' },
    ],
  ...
  'donjon-button': {
    ...
    props: [
      ...
      { name: 'variant',      type: "'default'|'primary'|'danger'|'success'|'warning'|'link'",            required: false, default: "'default'", description: 'Barevná varianta. `primary` = solid gold fill, `link` = textový button bez shellu. Parita s TkajUI Button.' },
  ...
  'event-log': {
    ...
    props: [
      ...
      { name: 'renderEvent',  type: '(entry, defaultRender) => ReactNode',              required: false, description: 'Custom renderer pro jednotlivou událost. Druhý argument je default JSX pro fallback.' },
  ...
  'donjon-select': {
    ...
    props: [
      ...
      { name: 'label',       type: 'string',                                               required: false, description: 'Popisek nad triggerem.' },
      { name: 'size',        type: "'xs'|'sm'|'md'|'lg'",                                      required: false, default: "'md'",      description: 'Výška triggeru.' },
      { name: 'variant',     type: "'default'|'danger'|'success'|'warning'|'info'",       required: false, default: "'default'", description: 'Barevná varianta. Parita s TkajUI Select.' },
      { name: 'disabled',    type: 'boolean',                                              required: false, default: 'false',     description: 'Zakáže celý select.' },
    ],
  ...
  'donjon-toggle': {
    ...
    props: [
      ...
      { name: 'size',          type: "'sm'|'md'",                                                required: false, default: "'md'",      description: 'Velikost přepínače.' },
      { name: 'variant',       type: "'default'|'danger'|'success'|'warning'|'info'",          required: false, default: "'default'", description: 'Barevná varianta. Parita s TkajUI Toggle.' },
      { name: 'disabled',      type: 'boolean',                                                  required: false, default: 'false',     description: 'Znepřístupní přepínač.' },
      { name: 'id',            type: 'string',                                                   required: false, description: 'HTML id pro label binding přes htmlFor. Parita s TkajUI Toggle.' },
    ],
  ...
  'donjon-progress-bar': {
    ...
    props: [
      ...
      { name: 'flash',         type: 'boolean',                                                                             required: false, default: 'false',     description: 'Damage flash animace. Herní extra.' },
  ...
  'donjon-pictogram': {
    ...
    props: [
      ...
      { name: 'variant',   type: "'active'|'passive'|'disabled'|'danger'|'success'", required: false, default: "'active'", description: 'Barevná varianta — určuje barvu ikony a pozadí. Ignoruje se pokud je předán `color`.' },
  ...
  'scoop-clip': {
    ...
    props: [
      ...
      { name: 'style',       type: 'CSSProperties', required: false, description: 'Inline styly. V circle módu width/height auto-vyplní z SHAPE_SIZES[size] pokud nejsou nastaveny.' },
  ...
  'notched-box': {
    ...
    props: [
      ...
      { name: 'borderColor', type: 'string',                            required: false, description: 'Barva borderu — renderuje podkladovou vrstvu se stejným tvarem.' },
      { name: 'borderWidth', type: 'number',                            required: false, default: '1', description: 'Tloušťka borderu v px.' },
