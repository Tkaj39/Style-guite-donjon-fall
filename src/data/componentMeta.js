...
export const componentMeta = {
  ...
  'dice-tower': {
    ...
    props: [
      ...
      { name: 'onTopHover',   type: '(hovered: boolean) => void',   required: false,                    description: 'Cursor enter / leave on the top (owning) die. Adds a gold glow ring while hovered.' },
      { name: 'onTowerHover', type: '(hovered: boolean) => void',   required: false,                    description: 'Cursor enter / leave on the peeks of the lower dice. Mutually exclusive with onTopHover.' },
      { name: 'onTopClick',   type: '(e: MouseEvent) => void',      required: false,                    description: 'Click on the top die — e.g. attack / capture action.' },
      { name: 'onTowerClick', type: '(e: MouseEvent) => void',      required: false,                    description: 'Click on lower-dice peeks — e.g. inspect tower history.' },
    ],
