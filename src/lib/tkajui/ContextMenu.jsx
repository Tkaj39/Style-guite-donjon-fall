/* ── ContextMenu (tkajui) ────────────────────────────────────────────
   Right-click menu. Wraps an area; on contextmenu the same popover
   used by DropdownMenu is rendered at the cursor position. Outside
   click / ESC / item click closes.
...
export default function ContextMenu({
  ...
  // Clamp menu to viewport on next paint to avoid overflow
  useEffect(() => {
