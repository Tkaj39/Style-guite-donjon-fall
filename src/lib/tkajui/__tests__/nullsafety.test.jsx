...
describe('Select null/undefined safety', () => {
  ...
  it('onChange={null} → kliknutí na option necrashne', () => {
    expect(() => {
...
describe('Slider edge values', () => {
  ...
  it('min={50} max={10} → necrashne (invertovaný range)', () => {
