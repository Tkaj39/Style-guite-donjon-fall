        ...
        <Preview>
          <div style={{ color: textCool, fontSize: '0.875rem', lineHeight: 1.6 }}>
            ...
            <ul style={{ margin: 0, padding: '0 0 0 18px', display: 'flex', flexDirection: 'column', gap: 4 }}>
              <li><code style={{ color: goldMid }}>"bottom-right"</code> — výchozí, pravý dolní roh</li>
              <li><code style={{ color: goldMid }}>"top-right"</code> — pravý horní roh</li>
              <li><code style={{ color: goldMid }}>"bottom-left"</code> — levý dolní roh</li>
              <li><code style={{ color: goldMid }}>"top-left"</code> — levý horní roh</li>
            </ul>
          </div>
        </Preview>
