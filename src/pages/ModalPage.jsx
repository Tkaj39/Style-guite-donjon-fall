...
<${cmp} showCloseButton={false} footer={<${btnCmp} onClick={() => setOpen(false)}>Zavřít</${btnCmp}>} …>
  …
      ...
      <Section
        ...
        description="Když je modál otevřený, obsah za ním by měl dostat atribut inert — prohlížeč pak automaticky zabrání focusu, klikům i čtení čtečkou. React 19 podporuje inert jako JSX prop přímo."
      >
        <Preview>
          <InertDemo {...ctx} />
        </Preview>
