...
const MANUAL_TASKS = [
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'done',        text: 'Pictograms — Hex icon pro mapové pole / hex' },
      { status: 'done',        text: 'Pictograms — Base icon pro základnu hráče / spawn hexy' },
      { status: 'done',        text: 'Pictograms — Focal Point icon pro ohnisko' },
      { status: 'done',        text: 'Pictograms — Active Focal Point variant pro aktivní ohnisko' },
      { status: 'done',        text: 'Pictograms — Passive Focal Point variant pro pasivní ohnisko' },
      { status: 'done',        text: 'Pictograms — Push icon pro odtlačení nepřátelské formace' },
      { status: 'done',        text: 'Pictograms — Occupy icon pro naskočení na nepřátelskou věž' },
      { status: 'done',        text: 'Pictograms — Encirclement icon pro sevření a zničení' },
      { status: 'done',        text: 'Pictograms — Tower Collapse icon pro kolaps věže' },
      { status: 'done',        text: 'Pictograms — Sudden Death icon pro okamžitou prohru bez legální akce' },
      { status: 'done',        text: 'Pictograms — Turn Order icon pro pořadí hráčů / iniciativu' },
      { status: 'done',        text: 'Shapes — doplnit interaktivní demo CornerOrnament variant' },
      { status: 'done',        text: 'Tokens — exportovat CSS custom properties ze style guidu' },
    ],
  },
  {
