...
const MANUAL_TASKS = [
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'todo',        text: 'Pictograms — Hex icon pro mapové pole / hex' },
      { status: 'todo',        text: 'Pictograms — Base icon pro základnu hráče / spawn hexy' },
      { status: 'todo',        text: 'Pictograms — Focal Point icon pro ohnisko' },
      { status: 'todo',        text: 'Pictograms — Active Focal Point variant pro aktivní ohnisko' },
      { status: 'todo',        text: 'Pictograms — Passive Focal Point variant pro pasivní ohnisko' },
      { status: 'todo',        text: 'Pictograms — Push icon pro odtlačení nepřátelské formace' },
      { status: 'todo',        text: 'Pictograms — Occupy icon pro naskočení na nepřátelskou věž' },
      { status: 'todo',        text: 'Pictograms — Encirclement icon pro sevření a zničení' },
      { status: 'todo',        text: 'Pictograms — Tower Collapse icon pro kolaps věže' },
      { status: 'todo',        text: 'Pictograms — Sudden Death icon pro okamžitou prohru bez legální akce' },
      { status: 'todo',        text: 'Pictograms — Turn Order icon pro pořadí hráčů / iniciativu' },
